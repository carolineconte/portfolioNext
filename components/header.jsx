  ...
  return (
    <>
      <header className="md:hidden w-full z-[999]">
        <div className="w-full fixed text-right pt-2 px-6 top-0 border-b border-slate-300 dark:border-blue-50/80">
      ...
      <header className='z-[999] hidden sm:block'>
        ...
        bg-green-500  bg-opacity-30 backdrop-blur-[0.5rem] border border-black border-opacity-20 shadow-xl rounded-full
